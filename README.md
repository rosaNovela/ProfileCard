# ProfileCard
Responsive Profile Card | HTML5 & CSS3
...
Optimization: Semantic HTML tags used for better accessibility (A11y) and SEO.
Design: Custom Google Fonts integration and a curated color palette.
